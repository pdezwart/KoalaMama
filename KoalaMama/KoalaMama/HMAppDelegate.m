...
-(void)applicationDidFinishLaunching:(UIApplication *)application
{
    ...
    NSURL *storeURL = [documentPath URLByAppendingPathComponent:@"KoalaMamaDB.sqlite"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"KoalaMama" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"KoalaMama.sqlite"];
